...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BSIT"/>Madhabdi<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>Badda<input type="radio" name="branch" value="BSSE"/>Dhanmondi</div>
            </div>   
